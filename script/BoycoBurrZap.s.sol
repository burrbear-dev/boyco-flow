...
contract BoycoBurrZapScript is Script {
    // cArtio environment
    ...
    function run() public {
        vm.startBroadcast();
        // cartio deployment
        BoycoBurrZap zap = new BoycoBurrZap(USDC, NECT_USDC_HONEY_POOL, HONEY_FACTORY, NECT, PSM_BOND_PROXY);
        // whitelist sender
    ...
    function _deployCartio() internal {}
}
